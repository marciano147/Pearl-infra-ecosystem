...
The system SHALL support explorer views for mining-related blocks, miner addresses, network difficulty/hashrate metrics, and proof/useful-work metadata when available from Pearl sources.
...
The system SHALL detect and expose OP_RETURN/null-data outputs and other recognized standard Pearl output types for explorer and data-anchoring apps.
